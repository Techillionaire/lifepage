            ...
            <div class="col-4 bg-dark  shadow">
                <form className='align-items-center m-5 text-white justify-content-center'>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 ms-2 d-flex align-items-center">
                            <FaUserAlt />
                        <input type="email" class="form-control ms-3" id="inputEmail" placeholder='Email'/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 ms-2 d-flex align-items-center">
                            <FaLock />
                        <input type="password" class="form-control ms-3" id="inputPassword" placeholder='Password'/>
                        </div>
                    </div>
                    <div class="row mb-3">
